...
class CharParser:
    ...
    def __call__(self, text: str) -> Optional[List[int]]:
        ...
        # text_tokens = self._tokenize_phoneme(text)
    ...
    def _tokenize_phoneme(self, text: str) -> List[int]:
        tokens = []
        #print('text:',text)
        # Split by word for find special labels.
        for word_id, word in enumerate(text.split(' ')):
            ...
            for phoneme in word.split('_'):
                tokens.append(self._labels_map.get(phoneme, self._unk_id))
